...
impl TryFrom<&str> for Piece {
    ...
    fn try_from(piece: &str) -> Result<Self, Self::Error> {
        match piece {
            "♙" => Ok(Piece { side: Side::White, ptype: PieceType::Pawn }),
            "♘" => Ok(Piece { side: Side::White, ptype: PieceType::Knight }),
            "♗" => Ok(Piece { side: Side::White, ptype: PieceType::Bishop }),
            "♖" => Ok(Piece { side: Side::White, ptype: PieceType::Rook }),
            "♕" => Ok(Piece { side: Side::White, ptype: PieceType::Queen }),
            "♔" => Ok(Piece { side: Side::White, ptype: PieceType::King }),
            "♟" => Ok(Piece { side: Side::Black, ptype: PieceType::Pawn }),
            "♞" => Ok(Piece { side: Side::Black, ptype: PieceType::Knight }),
            "♝" => Ok(Piece { side: Side::Black, ptype: PieceType::Bishop }),
            "♜" => Ok(Piece { side: Side::Black, ptype: PieceType::Rook }),
            "♛" => Ok(Piece { side: Side::Black, ptype: PieceType::Queen }),
            "♚" => Ok(Piece { side: Side::Black, ptype: PieceType::King }),
            _ => Err(InvalidPieceError { msg: String::from(piece) })
        }
    }
}
...
mod tests {
    ...
    fn test_piece_try_from() {
        assert_eq!(Piece { side: Side::White, ptype: PieceType::Queen },
